...
<!-- Địa điểm trong tour T001 -->
<h2>Địa điểm tham quan trong tour T001</h2>
<table>
    <tr>
        <th>Mã địa điểm</th>
        <th>Tên địa điểm</th>
...
<xsl:for-each select="QLTour/DSDiaDiem/DiaDiem[@maDiaDiem = /QLTour/DSTour/Tour[@maTour='T001']/DSDiaDiem-ref/DiaDiem-ref/@maDiaDiem]">
    <tr>
